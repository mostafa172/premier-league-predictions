...
-- Insert all 2024/25 Premier League teams
...
('Ipswich Town', 'IPS', '/assets/logos/ipswich.png', '#0033A0', '#FFFFFF', 1878, 'Portman Road'),
('Leicester City', 'LEI', '/assets/logos/leicester.png', '#003090', '#FDBE11', 1884, 'King Power Stadium'),
...
('Southampton', 'SOU', '/assets/logos/southampton.png', '#D71920', '#130C0E', 1885, 'St. Marys Stadium'),
